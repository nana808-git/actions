...
module "ecs-pipeline" {
  ...
  public_subnets   = ["module.vpc.aws_subnet.public[0].id", "module.vpc.aws_subnet.public[1].id"]
  private_subnets  = ["module.vpc.aws_subnet.private[0].id", "module.vpc.aws_subnet.private[1].id"]
